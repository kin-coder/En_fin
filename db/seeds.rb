...
Product.create(service: s4,name:"Décoration Anniversaire Fête",description:"Ballons hélium & ballons normaux, confettis, lumière d’ambiance",price:20)
Product.create(service: s4,name:"Fontaine à chocolat",description:"(fournie avec chocolat)",price:20)
Product.create(service: s4,name:"Plateau de fruits frais",description:"(pour deux personnes)",price:20)
