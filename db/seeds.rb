...
listdepartement.each do |listdepartement|
  Department.create(code: listdepartement[0], namedepartment: listdepartement[1], country: country)
  puts listdepartement[0]
end

# ======================== PRESTATAIRES ====================== #

# Prestataire.create(email: "",password:"MotDePasseMandonaBe",first_name: Faker::Name.first_name, last_name: Faker::Name.middle_name, adresse: nil, tel: nil, raison_sociale: nil, siret: nil)
